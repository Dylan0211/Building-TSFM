...
def eval_model(model, dset_test, prediction_filter_length):
...
if __name__ == '__main__':
    ...
    ckpt_path = 'ttm_finetuned_models/clft/output/checkpoint-final'
    ...
    # note: evaluation
    dset_train, dset_val, dset_test = get_data(dataset_name=dataset_name,
                                               file_name=file_path,
    ...
    # eval model
    cv_rmse, mae = eval_model(model, dset_test, prediction_filter_length)
